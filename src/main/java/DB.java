...
public class DB {
    ...
    String connectionString = "jdbc:postgresql://ec2-54-91-178-234.compute-1.amazonaws.com:5432/dbdc742197ov6v";
    Sql2o sql2o = new Sql2o(connectionString, "isykkquuzljlnh", "\n" +
